---
title: Will I Catch That Train
date: "2025-08-15"
summary: A Streamlit web app that helps me decide when to leave home for the J, Z, M subway lines in NYC.  
tags: ["Subway","API", "Real-Time", "NYC"]
repo: https://github.com/Vibhav-Misra/will-i-catch-that-train
demo: https://huggingface.co/spaces/VibzMiz/will-i-catch-that-train
---
...
- Static GTFS → schedules, stops, shapes (downloaded zip you placed in data/).
